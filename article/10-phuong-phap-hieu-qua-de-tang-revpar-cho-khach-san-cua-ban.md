...
Ví dụ: Khách sạn có 200 phòng, giá phòng trung bình mỗi ngày là 100 $, ngày tính RevPAR có tổng doanh thu là 16,000 $, [công suất phòng](https://nhavantuonglai.com/article/hieu-dung-ve-cong-suat-phong-khi-lam-khach-san) là 0.8 (160/200 phòng đã có khách). Theo đó, RevPAR sẽ được tính với 2 công thức là như sau:

– Công thức tính theo số phòng có sẵn: 16,000 ($) / 200 ($) = 80 ($).

– Công thức tính theo công suất phòng: 100 ($) – 0.8 = 80 ($).

Như vậy, ngày hôm đó, khách sạn đã thu về 80$ từ mỗi phòng. Bên cạnh đó, bạn cũng cần hiểu rằng, để đạt mục tiêu là 100% công suất phòng bằng cách giảm [ADR](https://nhavantuonglai.com/article/10-phuong-phap-hieu-qua-de-tang-adr-cho-khach-san-cua-ban) là lựa chọn không có lợi về mặt lợi nhuận, thay vào đó, khách sạn cần tăng RevPAR.
...
Để cải thiện, hãy tập trung vào [bán phòng trực tiếp](https://nhavantuonglai.com/article/khai-thac-du-lieu-tu-booking-engine-de-tang-luong-dat-phong-truc-tiep-cho-khach-san). Tất cả những gì bạn cần làm là có một công cụ đặt phòng được tích hợp trên website khách sạn, có khả năng chuyển đổi khách truy cập thành khách đặt phòng.
