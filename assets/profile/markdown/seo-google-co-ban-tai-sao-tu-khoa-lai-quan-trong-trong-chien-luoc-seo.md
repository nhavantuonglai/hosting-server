...
title: Cẩm nang tối ưu SEO chuẩn Google cơ bản | Tại sao từ khóa lại quan trọng trong chiến lược SEO?
...
Từ khóa có còn quan trọng đối với [tối ưu hóa công cụ tìm kiếm](https://www.searchenginejournal.com/seo-guide/) (SEO) không?
...
[Từ khóa SEO](https://www.searchenginejournal.com/keyword-research/) bao gồm từ các từ đơn lẻ đến các cụm từ phức tạp và được sử dụng để thông báo nội dung trang web để tăng lưu lượng truy cập tìm kiếm không phải trả tiền có liên quan.

Đối tượng của bạn sử dụng chúng khi tìm kiếm thứ gì đó liên quan đến thương hiệu của bạn.

Khi được nghiên cứu và tối ưu hóa hiệu quả, từ khóa hoạt động như một ống dẫn để kết nối đối tượng mục tiêu với trang web của bạn.

[![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/what-arekeywords-5fccdfb905073-768x167.png)](https://www.searchenginejournal.com/wp-content/uploads/2020/12/what-arekeywords-5fccdfb905073-768x167.png)
...
### 1. _Từ khóa (không được cung cấp)._
...
Tuy nhiên, mọi thứ bắt đầu thay đổi vào năm 2010 khi Google bắt đầu [lặng lẽ thực hiện các bước để xóa dữ liệu từ khóa](https://googleblog.blogspot.com/2010/05/search-more-securely-with-encrypted.html). Vào cuối năm 2011 đến năm sau, một lượng đáng kể khả năng hiển thị từ khóa không phải trả tiền sẽ bị tước bỏ.

Sẽ không mất nhiều thời gian để trình điều khiển từ khóa hàng đầu cho mọi trang web là _(không được cung cấp)_.

[![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/soucemedium-5fccdfbb21cf3-768x326.png)](https://www.searchenginejournal.com/wp-content/uploads/2020/12/soucemedium-5fccdfbb21cf3-768x326.png)
...
### 2. _AI và NLP đã làm cho từ khóa trở nên lỗi thời._

Một lần khác tính hợp lệ của từ khóa bị thách thức là khi [Google xây dựng lại thuật toán của mình vào năm 2013](https://www.searchenginejournal.com/google-algorithm-history/hummingbird-update/).
...
Vào năm 2015, Google đã kết hợp yếu tố xếp hạng do AI điều khiển, [RankBrain](https://www.searchenginejournal.com/google-algorithm-history/rankbrain/), vào hỗn hợp để cải thiện hơn nữa khả năng giải thích truy vấn của mình.
...
[BERT](https://www.searchenginejournal.com/bert-explained-what-you-need-to-know-about-googles-new-algorithm/337247/) đã được đưa vào thuật toán của Google vào cuối năm 2019.
...
Đã qua rồi cái thời mà Google bỏ qua _từ dừng_.
...
### 3. _Tìm kiếm bằng giọng nói khiến từ khóa trở nên vô dụng._
...
Ngày xưa, nếu chúng ta muốn biết người vợ đầu tiên của Brad Pitt là ai, chúng ta sẽ chuyển suy nghĩ của mình thành một truy vấn thân thiện với tìm kiếm, như _vợ của Brad Pitt_.

Bây giờ, chúng tôi chỉ cần nói với Google những gì chúng tôi muốn: _[Ai là vợ đầu tiên của Brad Pitt?](https://www.google.com/search?q=who+was+brad+pitts+first+wife\&oq=who+was+brad+pitts+first+wife\&aqs=chrome…69i57j69i64.3359j0j1\&sourceid=chrome\&ie=UTF-8)_.

Đây là một trong những lý do chính tại sao [15% tìm kiếm chưa bao giờ được Google nghe nói đến](https://www.blog.google/products/search/our-latest-quality-improvements-search/) trước đây mỗi ngày.
...
Bạn có biết thông qua tìm kiếm bằng giọng nói, bạn có thể [biết khi nào album đầu tiên của Scarlett Johansson](https://youtu.be/YF1LXYzWijE) được phát hành từ một truy vấn không bao gồm tên của cô ấy hoặc tên album của cô ấy? (Lưu ý phụ: Bạn có biết Scarlett Johansson đã có một album không?)
...
### 4. _Công cụ lập kế hoạch từ khóa đã chứng minh từ khóa không khác nhau lắm._

[Bắt đầu từ năm 2014](https://adwords.googleblog.com/2014/08/close-variant-matching-for-all-exact.html) và đẩy mọi thứ lên một tầm cao [hai năm sau đó](http://www.thesempost.com/googles-keyword-planner-now-combines-keywords-for-search-volume/), công cụ Keyword Planner của Google bắt đầu nhóm khối lượng cho các thuật ngữ tương tự.
...
[Google cho biết](https://support.google.com/adwords/answer/2497836) lý do cho điều này để đảm bảo _bạn không bỏ lỡ khách hàng tiềm năng_ và để _tối đa hóa tiềm năng cho quảng cáo của bạn hiển thị trên các tìm kiếm có liên quan_.
...
Tuy nhiên, điều này không giải thích tại sao [tìm kiếm của Google thường sẽ làm rung chuyển đáng kể kết quả của nó](http://sandboxseo.com/keyword-planner-combined-volume/) cho các từ khóa mà Google Keyword Planner cho là đủ đồng nghĩa để gộp lại với nhau.
...
Hãy quên đi từ khóa, thứ hạng, lưu lượng truy cập hoặc thậm chí trang web của bạn trong một phút.
...
Trong cuốn sách của mình, _Mọi người đều nói dối_,[ Seth Stephens-Davidowitz chia sẻ những phát hiện của mình](http://freakonomics.com/podcast/big-penis-things-ask-google/) về những gì hành vi tìm kiếm nói về tâm lý con người.
...
Về cốt lõi, nghiên cứu từ khóa là một công cụ [nghiên cứu](https://www.searchenginejournal.com/keyword-research/) thị trường mạnh mẽ có thể được tận dụng theo nhiều cách khác nhau, không chỉ thông báo nội dung trang web.
...
[Personas](https://www.searchenginejournal.com/buyer-personas/232341/) hoạt động như bullseyes.
...
[![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/seo-tylor-5fccdfc04e660-768x497.png)](https://www.searchenginejournal.com/wp-content/uploads/2020/12/seo-tylor-5fccdfc04e660-768x497.png)
...
Các từ hạt giống thường có liên quan đến hầu hết các trang web của bạn, nếu không phải tất cả.
...
[![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/dinosaur-5fccdfa4ac0bc-768x384.png)](https://www.searchenginejournal.com/wp-content/uploads/2020/12/dinosaur-5fccdfa4ac0bc-768x384.png)
...
Các thuật ngữ này có thể được sử dụng trong ngữ cảnh của toàn bộ trang web của bạn hoặc một trang duy nhất.
...
2. Người tìm kiếm có xác suất cao ở một khu vực nhất định: Ví dụ, _Tại sao Oklahoma Joe lại đổi tên?_ có thể được coi là một thuật ngữ địa phương vì rất có thể người tìm kiếm đến từ Kansas hoặc Missouri. Tại sao? Đó là hai tiểu bang duy nhất mà cơ sở thịt nướng đặc biệt này gọi là nhà. Nhân tiện, bây giờ nó được gọi là Joe's Kansas City BBQ nếu bạn tình cờ đi qua thị trấn.
...
Lần cuối cùng bạn bắt đầu tìm kiếm với _Tôi là một nhà tiếp thị kỹ thuật số XX tuổi, có trình độ đại học đang tìm kiếm \[phần còn lại của tìm kiếm của bạn]_ là khi nào?

Tôi sẽ đi ra ngoài trên một chi và đoán điều này chưa bao giờ xảy ra.

Tuy nhiên, 'ai' đằng sau người tìm kiếm thường có thể được tìm thấy trong thông tin ngầm của truy vấn.
...
Google thường ưu tiên nội dung mới cho các từ khóa theo chủ đề vì _truy vấn xứng đáng được làm mới_.
...
[![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/valentines-gift-ideas-5fccdfa8db5c8-768x390.png)](https://www.searchenginejournal.com/wp-content/uploads/2020/12/valentines-gift-ideas-5fccdfa8db5c8-768x390.png)
...
Chúng ta tìm kiếm bằng vỏ não mới nhưng [bộ não bò sát và paleopallium của chúng ta thường đưa ra quyết định](https://thesalesblog.com/2013/04/05/selling-to-all-three-brains/).

[Sara Howard mô tả carewords](http://www.flyingsolo.com.au/marketing/business-writing/keywords-vs-carewords) bằng cách sử dụng một ví dụ về việc mua một chiếc xe hơi.
...
Nói tóm lại, carewords là các thuật ngữ tạo ra lưu lượng truy cập thấp đến không có lưu lượng truy cập làm tăng mức độ tương tác và chuyển đổi trên trang web cho lưu lượng truy cập hiện có.
...
[Đây là một nguồn tài nguyên tuyệt vời](https://www.searchenginejournal.com/choose-right-keywords-optimize-for/335719/) để giúp bạn bắt đầu.
...
![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/keywords-and-seos-5fccdfaca758c.png)
...
3\. **Thu thập** dữ liệu từ khóa hiện tại (nếu trang web của bạn đã tồn tại). Tạo danh sách những gì hiện đang (và gần như) hướng lưu lượng truy cập đến trang web của bạn. Dưới đây là một số công cụ xếp hạng từ khóa có thể giúp với giai đoạn này:
...
![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/keywords-5fccdfb0af326.png)
...
[![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/venn-diagram-5fccdfb2d17d8.png)](https://www.searchenginejournal.com/wp-content/uploads/2020/12/venn-diagram-5fccdfb2d17d8.png)
...
## Làm thế nào để bạn sử dụng từ khóa để tối ưu hóa trang web của bạn?

Giống như chọn từ khóa, tối ưu hóa hiệu quả trang web của bạn cho các từ khóa có thể sống trên bài đăng trên blog của riêng nó.

Tuy nhiên, đây là một vài mẹo để bắt đầu.

### Nơi thêm từ khóa trên trang web

![Tại sao từ khóa vẫn rất quan trọng đối với SEO](https://www.searchenginejournal.com/wp-content/uploads/2020/12/keywords-on-webpage-5fccdfb6c4281.png)
...
– Liên kết nội bộ và nội dung xung quanh: Kết hợp các từ khóa vào [văn bản neo](https://www.searchenginejournal.com/link-building-anchor-text-3-things-you-need-to-know/383981/) của các liên kết trỏ đến trang của bạn giúp hiển thị cho Google nội dung trang của bạn. Tương tự, nội dung gần văn bản neo trỏ đến trang của bạn cũng quan trọng đối với Google và, ở mức độ thấp hơn, được sử dụng để mô tả trang đích.
...
– Thuộc tính alt của hình ảnh: Thẻ Alt không chỉ làm cho trang web của bạn trở nên toàn diện hơn cho đối tượng khiếm thị mà còn cung cấp cho Google ý tưởng tốt hơn về hình ảnh của bạn. Kết hợp các từ khóa khi thích hợp.
...
– Thẻ ARIA: Thẻ [ARIA](https://www.w3.org/WAI/intro/aria) tương tự như các thuộc tính alt ở chỗ chúng giúp làm cho nội dung trang web dễ tiếp cận hơn với những người khuyết tật. Bạn có thể sử dụng thẻ ARIA trên một số loại nội dung động, nội dung tương tác, hình nền…
...
– Đừng lạm dụng nó: [Tối ưu hóa quá mức](https://www.searchenginejournal.com/over-optimized-content/209698/) (hoặc _nhồi nhét từ khóa_) là một điều có thật. Nó có thể quay lưng với khách hàng của bạn và đưa bạn đến nhà chó (hoặc[ Panda](https://www.searchenginejournal.com/google-algorithm-history/panda-update/)) của Google. Mỗi một trong những lĩnh vực trên đã được tự động hóa, khai thác và làm hoen ố. Hãy tự hỏi liệu nó có giúp ích hay làm tổn thương trải nghiệm người dùng. Đưa ra quyết định của bạn dựa trên câu trả lời đó.
...
– Đừng tối ưu hóa từng trang trong chân không: Trừ khi bạn có [trang web một](https://www.searchenginejournal.com/single-page-websites-good-bad-seo/190095/) trang, bạn cần xem xét nhắm mục tiêu theo từ khóa của mình bằng cách đưa tất cả các trang vào ngữ cảnh. Điều này sẽ bảo vệ chống lại bất kỳ khoảng trống hoặc [ăn thịt từ khóa](https://www.searchenginejournal.com/on-page-seo/keyword-cannibalization/) nào có thể xảy ra khi bạn làm việc trên mỗi trang trong một silo.

– Kiểm tra mọi thứ: Nếu bạn có cơ hội làm việc trên các trang web có số lượng trang lớn, bạn có cơ hội hoàn hảo để thiết lập một số bài kiểm tra đáng giá để đánh bóng kỹ thuật của mình.
...
Như đã nói, tôi nghĩ rằng tôi có thể nói với bạn lần tới khi _từ khóa đã chết_ sẽ nảy dữ dội xung quanh các buồng tiếng vang SEO. Larry Page không chỉ muốn Google ở cấp độ của một con người, [ông muốn nó trở thành siêu nhân](https://www.wired.com/2014/05/for-larry-page-search-is-still-googles-ultimate-moonshot/).
...
Hãy giúp tôi và xem qua [lịch sử tìm kiếm của bạn](https://myactivity.google.com/myactivity).
