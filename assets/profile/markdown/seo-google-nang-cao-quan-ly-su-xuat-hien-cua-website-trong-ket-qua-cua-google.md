...
title: Cẩm nang tối ưu SEO chuẩn Google nâng cao | Quản lý sự xuất hiện của website trong kết quả của Google
...
{% code overflow="wrap" %}
```
protocol://nhavantuonglai/path/filename?querystring#fragment
```
{% endcode %}
...
{% code overflow="wrap" %}
```
https://www.nhavantuonglai.com/RunningShoes/Womens.htm?size=8#info
```
{% endcode %}

Theo khuyến nghị của Google, mọi website đều nên dùng https:// khi có thể. Tên máy chủ là nơi lưu trữ website của bạn, thường có tên miền giống với tên miền bạn dùng cho email. Google có phân biệt phiên bản www với phiên bản không có www (ví dụ: [www.nhavantuonglai.com](https://www.nhavantuonglai.com/viet-lach/) và [nhavantuonglai.com](https://nhavantuonglai.com/)). Khi thêm website vào Search Console, bạn nên thêm cả hai phiên bản http:// và https://, cũng như các phiên bản có www và không có www.
...
Đối với URL dẫn đến trang chủ, dấu gạch chéo (/) sau tên máy chủ là không bắt buộc vì đều dẫn đến cùng một nội dung ([https://www.nhavantuonglai.com/](https://nhavantuonglai.com/) cũng giống [https://www.nhavantuonglai.com](https://nhavantuonglai.com/)). Đối với đường dẫn và tên tệp, dấu gạch chéo sẽ được xem là một URL khác (dẫn đến tệp hoặc thư mục), ví dụ: [https://www.nhavantuonglai.com/viet-lach](https://www.nhavantuonglai.com/viet-lach/) không giống [https://www.nhavantuonglai.com/viet-lach/](https://www.nhavantuonglai.com/viet-lach/).
...
{% code overflow="wrap" %}
```
https://www.nhavantuonglai.com/viet-lach/12062021
```
{% endcode %}
...
{% code overflow="wrap" %}
```
https://www.nhavantuonglai.com/viet-lach/bai-viet-tren-instagram-ngay-12-thang-06-nam-2021
```
{% endcode %}
...
– Có các trang trên miền con và thư mục gốc truy cập vào cùng một nội dung, ví dụ: `nhavantuonglai.com/viet-lach` và `info.nhavantuonglai.com/viet-lach`.