...
title: Cẩm nang tối ưu SEO chuẩn Google cơ bản | Tạo biểu đồ bong bóng trong Google Search
...
Nếu bạn chưa đọc bài viết [kết nối Search Console với Looker Studio](https://developers.google.com/search/blog/2022/03/connecting-data-studio?hl=vi) và [theo dõi lưu lượng truy cập qua Google Search bằng Looker Studio](https://developers.google.com/search/blog/2022/03/monitoring-dashboard?hl=vi), hãy cân nhắc việc đọc những bài viết này để hiểu thêm về những gì bạn có thể làm được với Search Console trong Looker Studio.

## Đọc hiểu biểu đồ

Biểu đồ bong bóng là một công cụ trực quan rất hữu ích khi bạn xử lý dữ liệu có nhiều chỉ số và phương diện. Biểu đồ này giúp bạn quan sát được các mối quan hệ và tính quy luật trong dữ liệu một cách hiệu quả hơn. Trong ví dụ dưới đây, bạn có thể thấy [tỷ lệ nhấp](https://support.google.com/webmasters/answer/7576553?hl=vi#choosingmetrics) (CTR), vị trí trung bình và số lượt nhấp cho các phương diện truy vấn và thiết bị trong một chế độ xem.
...
Biểu đồ bong bóng hiển thị trên trang này sử dụng bảng Lượt hiển thị website có trong [nguồn dữ liệu của Search Console](https://support.google.com/datastudio/answer/7314895?hl=vi), trong đó có [dữ liệu hiệu suất trên Google Search](https://support.google.com/webmasters/answer/7576553?hl=vi) được tổng hợp theo website và cụm từ Google Search.

### Bộ lọc và các cách kiểm soát dữ liệu

Có 5 cách tuỳ chỉnh trong biểu đồ để giúp bạn kiểm soát dữ liệu sao cho hiệu quả:

1. [Kiểm soát dữ liệu](https://support.google.com/datastudio/answer/7415591?hl=vi): Chọn tài sản Search Console mà bạn muốn phân tích.

2. Phạm vi ngày: Chọn phạm vi ngày bạn muốn xem trong báo cáo; phạm vi ngày mặc định là 28 ngày gần nhất.

3. Cụm từ Google Search: Bao gồm hoặc loại bớt các cụm từ Google Search bạn cần chú trọng. Bạn có thể [lọc dữ liệu](https://developers.google.com/search/blog/2021/06/regex-negative-match?hl=vi) tương tự như cách bạn thực hiện trong Search Console.
...
7. Thang đo lôgarit: Việc sử dụng [thang đo lôgarit](https://en.wikipedia.org/wiki/Logarithmic\_scale) cho cả hai trục giúp bạn hiểu rõ hơn về các cụm từ Google Search nằm ở các điểm xa nhất trên biểu đồ (CTR rất thấp, vị trí trung bình rất thấp hoặc cả hai đều rất thấp).

8. [Đường tham chiếu](https://support.google.com/datastudio/answer/9921462?hl=vi): Đường tham chiếu rất hữu ích trong việc nêu bật các giá trị cao hơn hoặc thấp hơn một ngưỡng nhất định. Khi xem xét giá trị trung bình, số trung vị hoặc một bách phân vị nào đó, bạn có thể nhìn ra những điểm dữ liệu lệch khỏi quy luật.

### Bong bóng

Mỗi bong bóng trong biểu đồ đại diện cho một cụm từ Google Search, với các [thuộc tính định kiểu](https://support.google.com/datastudio/answer/7207785?hl=vi#style-properties) như sau:
...
2. Vị trí thấp, CTR cao: Các cụm từ này có vẻ phù hợp với người dùng; có CTR cao mặc dù nằm ở vị trí thấp hơn mức trung bình của cụm từ Google Search cho website của bạn. Việc vị trí trung bình của cụm từ Google Search tăng lên có thể có tác động đáng kể đến hiệu suất của bạn – hãy tập trung vào việc cải thiện SEO cho những cụm từ Google Search này. Ví dụ: cụm từ Google Search hàng đầu trong góc phần tư 2 cho một website về làm vườn có thể là "cách làm nhà kho bằng gỗ". Hãy kiểm tra xem bạn đã có trang về nội dung này chưa và tiến hành theo 2 cách: Nếu bạn chưa có trang nào, hãy cân nhắc tạo một trang như vậy để tập trung tất cả thông tin bạn có trên website của mình về chủ đề đó. Nếu bạn đã có một trang như vậy, hãy xem xét việc bổ sung nội dung để phù hợp hơn với trang mà người dùng đó cần.
...
Sau khi tìm thấy các cụm từ Google Search bằng hình ảnh minh hoạ trực quan trên trang này, bạn có thể [tạo một bộ lọc cụm từ Google Search](https://support.google.com/webmasters/answer/7576553?hl=vi#filteringdata) cho một số cụm từ Google Search cụ thể qua giao diện người dùng của Search Console hoặc dùng Looker Studio để tạo một [bảng tổng hợp](https://support.google.com/looker-studio/answer/7516660?hl=vi); theo cả hai cách, bạn đều có thể kiểm tra tất cả những trang đang nhận được lưu lượng truy cập cho một cụm từ Google Search cụ thể. Sau khi bạn biết những cụm từ Google Search mà mình muốn tối ưu hoá và các URL liên quan của cụm từ đó, hãy sử dụng [Cẩm nang SEO](https://www.nhavantuonglai.com/developer/cam-nang-toi-uu-seo-chuan-google-nang-cao-toi-uu-noi-dung) để tối ưu hoá nội dung của bạn. Dưới đây là một số mẹo hay:

– Đảm bảo rằng các phần tử [title](https://www.nhavantuonglai.com/developer/cam-nang-toi-uu-seo-chuan-google-co-ban-tac-dong-den-duong-lien-ket-tieu-de-trong-ket-qua-tim-kiem), [thẻ meta mô tả](https://developers.google.com/search/docs/appearance/snippet?hl=vi#meta-descriptions) và thuộc tính alt đều được trình bày chi tiết, cụ thể và chính xác.
...
– Suy nghĩ xem người dùng có khả năng sẽ sử dụng những từ nào để Google Search một nội dung cụ thể của bạn, chẳng hạn như từ đồng nghĩa và cụm từ liên quan. Bạn có thể sử dụng [Công cụ lập kế hoạch từ khoá](https://ads.google.com/home/tools/keyword-planner/?hl=vi) của Google Ads để khám phá các biến thể từ khoá mới và xem lượng Google Search ước chừng của mỗi từ khoá. Bạn cũng có thể sử dụng [Google Xu hướng](https://trends.google.com/trends/?hl=vi) để lấy ý tưởng qua các chủ đề và cụm từ Google Search đang thịnh hành có liên quan đến website của mình.
